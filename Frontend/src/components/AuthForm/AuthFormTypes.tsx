...
import { createMyProfile, logInProfile } from "../../asyncThunks/profileThunks";
      ...
      >
        <div className="rounded-t-lg rounded-r-2xl text-xl bg-gray-300 h-16 w-36 justify-center items-center flex">
          <h1 className="text-xl">
            {form === "Login" ? "Log In to Your Account" : "Create New Account"}
          </h1>
        </div>
        <label>
        ...
        <button
          ...
          type="submit"
          className="static p-1 w-28 border hover:bg-orange-700 text-white hover:scale-110 transition-all duration-300 border-white rounded"
        >
        ...
        <button
          type="button"
          className={clsx(
            "bg-transparent border-none desktop:hidden text-white"
          )}
